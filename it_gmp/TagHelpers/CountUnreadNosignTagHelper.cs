...
{
    public class CountUnreadNosignTagHelper : TagHelper
    {
        private readonly ItContext _context;
        private IActionContextAccessor actionAccessor;
        private UserManager<UserModel> UserManager;
        public CountUnreadNosignTagHelper(ItContext context, UserManager<UserModel> UserMgr, IActionContextAccessor ActionAccessor)
        {
            _context = context;
            UserManager = UserMgr;
        ...
        public override void Process(TagHelperContext context, TagHelperOutput output)
        {
            ...
            var document_signed = _context.DocumentSignatureModel.Where(d => d.status == 3 && (d.user_sign == user_id || d.user_id == user_id)).Select(d => d.document_id).ToList();
